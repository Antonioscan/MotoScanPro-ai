...
exports.handler = async (event) => {
  try {
        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: `Analizza l'oggetto nella foto. Genera una descrizione molto semplice e sintetica, ma professionale. Cerca in rete per riconoscere la marca precisa. Se possibile, indica anche il codice del prodotto e un prezzo medio in euro.`,
              },
              {
                type: "image_url",
    ...
    // Estrazione di codice, marca, prezzo (se trovati nel testo)
